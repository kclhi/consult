...
router.get('/:patientID/:code/:start/:end', function(req, res, next) {
  ...
  if ( req.params && req.params.patientID && req.params.code && req.params.start && req.params.end ) {
    ...
    getFHIRServer("Observation", "subject=" + req.params.patientID + "&code=" + req.params.code + "&date=gt" + req.params.start + "&date=lt" + req.params.end + "&_sort=-date&_count=10000", function(data) {
