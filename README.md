...
[View](https://github.kcl.ac.uk/pages/consult/device-integration_vitalpatch/).
...
The server runs by default on port 3008. Visit localhost:3008/[route] to test changes to GET endpoints and use software such as [Postman](https://www.getpostman.com/) to test changes to POST (and other) endpoints.
